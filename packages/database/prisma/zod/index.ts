...
export const WhatsAppMessageScalarFieldEnumSchema = z.enum(['id', 'organizationId', 'subaccountId', 'sessionId', 'direction', 'waMessageId', 'chatId', 'fromMe', 'body', 'type', 'status', 'origin', 'sentByUserId', 'sentByName', 'ghlMessageId', 'ghlSynced', 'idempotencyKey', 'timestamp', 'createdAt'])
...
export const WhatsAppConversationScalarFieldEnumSchema = z.enum(['id', 'organizationId', 'subaccountId', 'chatId', 'contactName', 'ghlContactId', 'ghlConversationId', 'ownerId', 'tags', 'activeSessionId', 'lastMessageAt', 'lastMessagePreview', 'lastDirection', 'unreadCount', 'createdAt', 'updatedAt'])
...
// File: WhatsAppSession.schema.ts
...
export type WhatsAppSessionType = z.infer<typeof WhatsAppSessionSchema>;


// File: WhatsAppMessage.schema.ts
