...
export const WhatsAppSettingsScalarFieldEnumSchema = z.enum(['id', 'subaccountId', 'globalSpintax', 'messageTemplates', 'groupsEnabled', 'createdAt', 'updatedAt'])
...
export const WhatsAppConversationSchema = z.object({
  ...
  crmPlaceholderPhone: z.string().nullish(),
